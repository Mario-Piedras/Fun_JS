...
// En el operador && = y, deben cumplirse dos condicions para retonar true.
if (pais == "Colombia" && edad >= 18){
    document.writeln("Eres ciudadano del pais de ", pais);
}else{
    document.writeln("No eres ciudadano del pais de ", pais);
}

//Operador || = o

let day, month, year;
 //Solicitar el dia mes y el año, luego se verificara que los valores sean numéricos.
...
if (isNaN(day) || isNaN(month) || isNaN(year)){
    document.writeln("<br> Por favor ingrese solamente valores númericos para el dia, el mes y el año");
}else if (month == 1 || month == 2 || month == 3){
    document.writeln("<br> Perteneces al trimer trimestre del año");
}else{
    document.writeln("<br> No perteneces al trimer trimestre del año");
}